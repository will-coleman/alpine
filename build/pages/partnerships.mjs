...
<div class="wrap">
  ...
  <section class="prose">
    <p>
      One person, so one project at a time, and I say no to things I can't do properly. I go, I
      film it, and I say what it was actually like — if it isn't good I'll say so, which is the
      only reason anyone believes the ones that are.
    </p>
