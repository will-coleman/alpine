...
export default async function work(ctx) {
  assertMarked(H1, "work-with-me h1");
  ...
  return [
    {
      ...
      html: page({
        title: "Work with me",
        description:
          "Long-form YouTube, short-form vertical and licensed stills for airlines, tourist boards and travel brands. Email for a rate card.",
        path: "/work-with-me/",
        ogImage: "/og/work.png",
        css: ctx.css,
        main,
